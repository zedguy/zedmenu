    ...
    internal class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] { // Settings
                ...
                new ButtonInfo { buttonText = "Change Fly Speed", overlapText = "Change Speed Boost Amount <color=grey>[</color><color=#96ffb2>Normal</color><color=grey>]</color>", method =() => Locomotion.changefly(), isTogglable = false, toolTip = "Changes the speed of fly mods."},
            ...
            new ButtonInfo[] { // Rig Mods
                ...
                new ButtonInfo { buttonText = "Stare At Nearby", method =() => Rig.StareAtNearby(), disableMethod =() => Rig.disablecopy(), toolTip = "looks at closest."},
